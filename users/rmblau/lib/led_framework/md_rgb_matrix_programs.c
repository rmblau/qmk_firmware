...
// pumpkin 255, 117, 24
led_setup_t leds_pumpkin[] = {
    {.hs = 0, .he = 100, .rs = 255, .re = 255, .gs = 140, .ge = 140, .bs = 0, .be = 0, .ef = EF_NONE},
...
void *led_setups[] = {leds_rainbow_s, leds_rainbow_ns, leds_teal_salmon, leds_yellow, leds_red, leds_green, leds_blue, leds_pumpkin, leds_white, leds_white_with_red_stripe, leds_black_with_red_stripe, leds_off};
